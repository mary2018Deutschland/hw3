...
function Rating() {
  ...
  return (
    <div style={{ margin: "0 auto", width: "800px" }}>
      ...
      ></img>
      <button onClick={() => handleClick(0)}>Плохо</button>
      <button onClick={() => handleClick(1)}>Приемлемо</button>
      <button onClick={() => handleClick(2)}>Хорошо</button>
      <button onClick={() => handleClick(3)}>Отлично</button>
    </div>
  );
}
